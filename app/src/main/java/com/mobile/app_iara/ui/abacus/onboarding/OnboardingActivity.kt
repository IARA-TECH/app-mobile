...
class OnboardingActivity : AppCompatActivity() {
    ...
    private val imagens = arrayOf(
        R.drawable.il_woman_photo,
        R.drawable.il_phone,
        R.drawable.il_analysis
    )
    ...
    private fun updatePage() {
        ...
        dot1.setImageResource(if (pagina == 0) R.drawable.shape_dot_active else R.drawable.shape_dot_inactive)
        dot2.setImageResource(if (pagina == 1) R.drawable.shape_dot_active else R.drawable.shape_dot_inactive)
        dot3.setImageResource(if (pagina == 2) R.drawable.shape_dot_active else R.drawable.shape_dot_inactive)
