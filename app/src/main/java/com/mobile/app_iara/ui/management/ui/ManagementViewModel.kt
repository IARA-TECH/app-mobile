package com.mobile.app_iara.ui.management.ui
...
class ManagementViewModel(private val application: Application) : AndroidViewModel(application) {
    ...
    private val _collaborators = MutableLiveData<List<CollaboratorData>>()
    val collaborators: LiveData<List<CollaboratorData>> = _collaborators
