...
class PrivacyAdapter(private val privacidades: List<Terms>) :
    RecyclerView.Adapter<PrivacyAdapter.PrivacidadeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PrivacidadeViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_privacy, parent, false)
